...
2. Create batch progress page at src/app/dashboard/bulk/[id]/page.tsx:
   ...
   - Show header: "Batch Progress" with batch ID
   ...
   - When complete, show "Batch Complete!" message
...
3. Update batch processor (src/lib/batch-processor.ts):
   - After batch completes, if notifyEmail is true:
     * Fetch batch job with lead info
...
<output>
After completion, create `.planning/phases/07-bulk-processing/07-03-SUMMARY.md` with:
