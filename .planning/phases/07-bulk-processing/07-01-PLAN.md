...
Purpose: Enable sales agents to upload CSV/Excel files with multiple business addresses for bulk quoting.
...
- Lead capture required before quote submission
</context>
...
- Navigate to /dashboard/bulk shows upload UI
